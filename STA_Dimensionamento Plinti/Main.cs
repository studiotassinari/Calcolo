...
namespace STA_Dimensionamento_Plinti
{
    public partial class Main : Form
    {
        ...
        {
            plintoSingoloForm plintoSingolo = new plintoSingoloForm();
            plintoSingolo.MdiParent = this;
            plintoSingolo.Show();
        }

        private void nuovoToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            formProgettoPlintiProgExt plintiProg = new formProgettoPlintiProgExt();
            plintiProg.MdiParent = this;
            plintiProg.Show();
        }
    }
}
